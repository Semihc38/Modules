...
SELECT name,countrycode FROM city WHERE population>8000000;
...
-- 12. The name, continent, and head of state of all countries whose form of government is a monarchy (43 rows) [HINT: check if the form of government contains the word Monarhcy (and yes... case matters so capitalize the M)]
...
SELECT name,region FROM country WHERE (continent='North America' OR continent='South America') AND NOT region='Caribbean';
