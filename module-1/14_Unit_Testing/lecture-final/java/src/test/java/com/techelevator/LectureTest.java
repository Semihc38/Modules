...
public class LectureTest {    // JUnits test are part of a class - like everything else in Java
	...
	@Test // Tells JUnit - here comes a Test, if omitted, JUnit does not see the test so it's not run
